...
export const AccountsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 bg-surface-container-lowest rounded-2xl border border-surface-container-highest shadow-sm">
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            ...
            <span>{selectedAccount.status === 'FROZEN' ? 'Unfreeze Account' : 'Freeze Account'}</span>
          </button>
        </div>
      </div>
      ...
      {/* Selected Account Deep Inspection Pane */}
        ...
        <div className="p-4 rounded-xl bg-surface-container-low border border-surface-container-highest flex flex-col gap-2">
          ...
          <div className="w-full h-2 rounded-full bg-surface-container-highest overflow-hidden">
            <div
              ...
              style={{ width: `${Math.min(100, (parseFloat(selectedAccount.dailyLimitUsed || '0') / parseFloat(selectedAccount.dailyLimit || '50000')) * 100)}%` }}
            ></div>
          </div>
        </div>

        {/* Filter and Ledger Table for Selected Account */}
