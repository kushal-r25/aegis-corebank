...
public class TransferController {
    ...
    public ResponseEntity<TransactionResponse> reverse(
            @PathVariable("transactionId") java.util.UUID transactionId,
    ...
    public ResponseEntity<TransactionResponse> get(@PathVariable("transactionId") java.util.UUID transactionId) {
